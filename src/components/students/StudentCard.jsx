    ...
    <div className="bg-black/50 backdrop-blur-xl border border-white/15 p-6 rounded-3xl shadow-2xl transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5">
      ...
      <div className="text-center">
        ...
        <div className="flex gap-2 mt-5">
          <button className="flex-1 p-2.5 rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 transition-all flex items-center justify-center gap-2 text-white text-[0.85rem] font-semibold">
            <Edit2 size={14} />
            <span>Modifier</span>
          </button>
          <button className="flex-1 p-2.5 rounded-xl border border-red-500/20 bg-red-500/10 text-[#ff6b6b] hover:bg-red-500/20 transition-all flex items-center justify-center gap-2 text-[0.85rem] font-semibold">
            <Trash2 size={14} />
            <span>Supprimer</span>
          </button>
        </div>
